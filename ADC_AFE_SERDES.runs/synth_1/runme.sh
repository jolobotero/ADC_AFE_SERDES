...
HD_PWD='D:/P_vhdl_Vi/ADC_AFE_SERDES/ADC_AFE_SERDES.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log adcClock_FclkFrm.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source adcClock_FclkFrm.tcl
