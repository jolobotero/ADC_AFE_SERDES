...
HD_PWD='D:/P_vhdl_Vi/ADC_AFE_SERDES/ADC_AFE_SERDES.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log adcClock_FclkFrm.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source adcClock_FclkFrm.tcl -notrace
